...
Table \ref{tablefeature} lists some of the features with the corresponding information gain, with more informative features towards the top. Full data is available here.
\begin{center}
    \begin{tabular}{|c|c|c|}
        \hline
